...
void RelCacheTable::recordToRelCatEntry(union Attribute record[RELCAT_NO_ATTRS], RelCatEntry *relCatEntry)
{
  ...
  relCatEntry->firstBlk = (int)record[RELCAT_FIRST_BLOCK_INDEX].nVal; //first block number
  relCatEntry->lastBlk = (int)record[RELCAT_LAST_BLOCK_INDEX].nVal; //last block number
